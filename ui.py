...
class MainForm(customtkinter.CTk):
    ...
    def init_components(self):
        ...
        compiled_data = CompiledData(self.db.sources, (lambda val: val.depth() == 1,), lambda ins: ins.name)
        counter = compiled_data.frequency
        ...
        canvas = FigureCanvasTkAgg(
            self.figure, master=self)  # Convert the Figure to a tkinter widget
